...
MAIN := src/main.cc src/module.cc src/modulerepository.cc src/sharedlibraryrepository.cc src/util/repository.cc src/windows/sharedlibrary.cc src/windows/thread.cc
